import {BookService, SeqeulizeBookRepository} from "../../../services/bookService";
...
export class GetBookByIdQueryResolver implements AbstractClassQueryResolver<GQLBook> {
    private parent: any;
    ...
    private executeResolver(): Promise<void> {
        ...
        return this.service.getBookById(this.args.id).then((value: BookInterface) => {
